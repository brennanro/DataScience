...
$con=mysqli_connect('localhost','root','fluffy22','dataScience');
	$sql="SELECT * FROM ukWaste ORDER BY TIME DESC";
	...
	mysqli_close($con);
	?><br><br>
<a href="links/ukWaste.csv" download>Download CSV</a><br><br>
<a href="links/ukWaste.xlsx" download>Download XLSX</a><br><br>
