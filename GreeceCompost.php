...
$con=mysqli_connect('localhost','root','fluffy22','dataScience');
	$sql="SELECT * FROM greeceCompost ORDER BY TIME DESC";
	...
	mysqli_close($con);
	?></iframe><br><br>
<a href="links/greececompost.csv" download>Download CSV</a><br><br>
<a href="links/greececompost.xlsx" download>Download XLSX</a><br><br>
