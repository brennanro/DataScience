...
$con=mysqli_connect('localhost','root','fluffy22','dataScience');
	$sql="SELECT * FROM czechRecycle ORDER BY TIME DESC";
	...
	mysqli_close($con);
	?><br><br>
<a href="links/czechrecycle.csv" download>Download CSV</a><br><br>
<a href="links/czechrecycle.xlsx" download>Download XLSX</a><br><br>
