...
$con=mysqli_connect('localhost','root','fluffy22','dataScience');
	$sql="SELECT * FROM portugalWaste ORDER BY TIME DESC";
	...
	mysqli_close($con);
	?><br><br>
<a href="links/portugalWaste.csv" download>Download CSV</a><br><br>
<a href="links/portugalWaste.xlsx" download>Download XLSX</a><br><br>
