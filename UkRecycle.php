...
$con=mysqli_connect('localhost','root','fluffy22','dataScience');
	$sql="SELECT * FROM ukRecycle ORDER BY TIME DESC";
	...
	mysqli_close($con);
	?><br><br>
<a href="links/ukrecycle.csv" download>Download CSV</a><br><br>
<a href="links/ukrecycle.xlsx" download>Download XLSX</a><br><br>
