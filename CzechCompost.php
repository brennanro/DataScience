...
$con=mysqli_connect('localhost','root','fluffy22','dataScience');
	$sql="SELECT * FROM czechCompost ORDER BY TIME DESC";
	...
	mysqli_close($con);
	?></iframe><br><br>
<a href="links/czechcompost.csv" download>Download CSV</a><br><br>
<a href="links/czechcompost.xlsx" download>Download XLSX</a><br><br>
