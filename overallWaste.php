...
$con=mysqli_connect('localhost','root','fluffy22','dataScience');
	$sql="SELECT * FROM overallWaste ORDER BY VALUE DESC";
	...
	mysqli_close($con);
	?><br><br>
<a href="links/overallWaste.csv" download>Download CSV</a><br><br>
<a href="links/overallWaste.xlsx" download>Download XLSX</a><br><br>
<a href="main.php">Back</a><br><br><br><br>
<img src ="pics/wasteBar.jpg">
