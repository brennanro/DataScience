...
$con=mysqli_connect('localhost','root','fluffy22','dataScience');
	$sql="SELECT * FROM irelandCompost ORDER BY TIME DESC";
	...
	mysqli_close($con);
	?></iframe><br><br>
<a href="links/irelandcompost.csv" download>Download CSV</a><br><br>
<a href="links/irelandcompost.xlsx" download>Download XLSX</a><br><br>
