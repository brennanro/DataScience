...
$con=mysqli_connect('localhost','root','fluffy22','dataScience');
	$sql="SELECT * FROM romainiaFill ORDER BY TIME DESC";
	...
	mysqli_close($con);
	?><br><br>
<a href="links/romaniaFill.csv" download>Download CSV</a><br><br>
<a href="links/romaniaFill.xlsx" download>Download XLSX</a><br><br>
