...
$con=mysqli_connect('localhost','root','fluffy22','dataScience');
	$sql="SELECT * FROM ukIncinerate ORDER BY TIME DESC";
	...
	mysqli_close($con);
	?><br><br>
<a href="links/ukincinerate.csv" download>Download CSV</a><br><br>
<a href="links/ukincinerate.xlsx" download>Download XLSX</a><br><br>
