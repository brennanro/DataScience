...
$con=mysqli_connect('localhost','root','fluffy22','dataScience');
	$sql="SELECT * FROM ukCompost ORDER BY TIME DESC";
	...
	mysqli_close($con);
	?><br><br>
<a href="links/ukcompost.csv" download>Download CSV</a><br><br>
<a href="links/ukcompost.xlsx" download>Download XLSX</a><br><br>
