...
$con=mysqli_connect('localhost','root','fluffy22','dataScience');
	$sql="SELECT * FROM norwayFill ORDER BY TIME DESC";
	...
	mysqli_close($con);
	?><br><br>
<a href="links/norwayFill.csv" download>Download CSV</a><br><br>
<a href="links/norwayFill.xlsx" download>Download XLSX</a><br><br>
