...
$con=mysqli_connect('localhost','root','fluffy22','dataScience');
	$sql="SELECT * FROM norwayCompost ORDER BY TIME DESC";
	...
	mysqli_close($con);
	?></iframe><br><br>
<a href="links/norwaycompost.csv" download>Download CSV</a><br><br>
<a href="links/norwaycompost.xlsx" download>Download XLSX</a><br><br>
