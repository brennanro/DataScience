...
$con=mysqli_connect('localhost','root','fluffy22','dataScience');
	$sql="SELECT * FROM irelandWaste ORDER BY TIME DESC";
	...
	mysqli_close($con);
	?><br><br>
<a href="links/irelandWaste.csv" download>Download CSV</a><br><br>
<a href="links/irelandWaste.xlsx" download>Download XLSX</a><br><br>
