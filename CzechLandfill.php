...
$con=mysqli_connect('localhost','root','fluffy22','dataScience');
	$sql="SELECT * FROM czechFill ORDER BY TIME DESC";
	...
	mysqli_close($con);
	?><br><br>
<a href="links/czechFill.csv" download>Download CSV</a><br><br>
<a href="links/czechFill.xlsx" download>Download XLSX</a><br><br>
