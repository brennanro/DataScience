...
$con=mysqli_connect('localhost','root','fluffy22','dataScience');
	$sql="SELECT * FROM italyWaste ORDER BY TIME DESC";
	...
	mysqli_close($con);
	?><br><br>
<a href="links/italyWaste.csv" download>Download CSV</a><br><br>
<a href="links/italyWaste.xlsx" download>Download XLSX</a><br><br>
