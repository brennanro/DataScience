...
$con=mysqli_connect('localhost','root','fluffy22','dataScience');
	$sql="SELECT * FROM czechIncinerate ORDER BY TIME DESC";
	...
	mysqli_close($con);
	?><br><br>
<a href="links/czechincinerate.csv" download>Download CSV</a><br><br>
<a href="links/czechincinerate.xlsx" download>Download XLSX</a><br><br>
