...
$con=mysqli_connect('localhost','root','fluffy22','dataScience');
	$sql="SELECT * FROM italyRecycle ORDER BY TIME DESC";
	...
	mysqli_close($con);
	?><br><br>
<a href="links/italyrecycle.csv" download>Download CSV</a><br><br>
<a href="links/italyrecycle.xlsx" download>Download XLSX</a><br><br>
