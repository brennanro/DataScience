...
$con=mysqli_connect('localhost','root','fluffy22','dataScience');
	$sql="SELECT * FROM greeceFill ORDER BY TIME DESC";
	...
	mysqli_close($con);
	?><br><br>
<a href="links/greeceFill.csv" download>Download CSV</a><br><br>
<a href="links/greeceFill.xlsx" download>Download XLSX</a><br><br>
