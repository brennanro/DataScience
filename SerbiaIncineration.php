...
$con=mysqli_connect('localhost','root','fluffy22','dataScience');
	$sql="SELECT * FROM serbiaIncinerate ORDER BY TIME DESC";
	...
	mysqli_close($con);
	?><br><br>
<a href="links/serbiaincinerate.csv" download>Download CSV</a><br><br>
<a href="links/serbiaincinerate.xlsx" download>Download XLSX</a><br><br>
