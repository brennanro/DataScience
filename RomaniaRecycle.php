...
$con=mysqli_connect('localhost','root','fluffy22','dataScience');
	$sql="SELECT * FROM romaniaRecycle ORDER BY TIME DESC";
	...
	mysqli_close($con);
	?><br><br>
<a href="links/romaniarecycle.csv" download>Download CSV</a><br><br>
<a href="links/romaniarecycle.xlsx" download>Download XLSX</a><br><br>
