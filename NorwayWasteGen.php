...
$con=mysqli_connect('localhost','root','fluffy22','dataScience');
	$sql="SELECT * FROM norwayWaste ORDER BY TIME DESC";
	...
	mysqli_close($con);
	?><br><br>
<a href="links/norwayWaste.csv" download>Download CSV</a><br><br>
<a href="links/norwayWaste.xlsx" download>Download XLSX</a><br><br>
