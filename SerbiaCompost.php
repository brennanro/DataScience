...
$con=mysqli_connect('localhost','root','fluffy22','dataScience');
	$sql="SELECT * FROM serbiaCompost ORDER BY TIME DESC";
	...
	mysqli_close($con);
	?><br><br>
<a href="links/serbiacompost.csv" download>Download CSV</a><br><br>
<a href="links/serbiacompost.xlsx" download>Download XLSX</a><br><br>
