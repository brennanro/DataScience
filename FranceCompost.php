...
$con=mysqli_connect('localhost','root','fluffy22','dataScience');
	$sql="SELECT * FROM franceCompost ORDER BY TIME DESC";
...
<a href="links/francecompost.csv" download>Download CSV</a><br><br>
<a href="links/francecompost.xlsx" download>Download XLSX</a><br><br>
