...
$con=mysqli_connect('localhost','root','fluffy22','dataScience');
	$sql="SELECT * FROM irelandIncinerate ORDER BY TIME DESC";
	...
	mysqli_close($con);
	?><br><br>
<a href="links/irelandincinerate.csv" download>Download CSV</a><br><br>
<a href="links/irelandincinerate.xlsx" download>Download XLSX</a><br><br>
