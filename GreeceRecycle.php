...
$con=mysqli_connect('localhost','root','fluffy22','dataScience');
	$sql="SELECT * FROM greeceRecycle ORDER BY TIME DESC";
	...
	mysqli_close($con);
	?><br><br>
<a href="links/greecerecycle.csv" download>Download CSV</a><br><br>
<a href="links/greecerecycle.xlsx" download>Download XLSX</a><br><br>
