...
$con=mysqli_connect('localhost','root','fluffy22','dataScience');
	$sql="SELECT * FROM austriaRecycle ORDER BY TIME DESC";
	...
	mysqli_close($con);
	?><br><br>
<a href="links/austriarecycle.csv" download>Download CSV</a><br><br>
<a href="links/austriarecycle.xlsx" download>Download XLSX</a><br><br>
