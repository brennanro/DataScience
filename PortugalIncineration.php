...
$con=mysqli_connect('localhost','root','fluffy22','dataScience');
	$sql="SELECT * FROM portugalIncinerate ORDER BY TIME DESC";
	...
	mysqli_close($con);
	?><<br><br>
<a href="links/portugalincinerate.csv" download>Download CSV</a><br><br>
<a href="links/portugalincinerate.xlsx" download>Download XLSX</a><br><br>
