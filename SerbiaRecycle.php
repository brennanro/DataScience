...
$con=mysqli_connect('localhost','root','fluffy22','dataScience');
	$sql="SELECT * FROM serbiaRecycle ORDER BY TIME DESC";
	...
	mysqli_close($con);
	?><br><br>
<a href="links/serbiarecycle.csv" download>Download CSV</a><br><br>
<a href="links/serbiarecycle.xlsx" download>Download XLSX</a><br><br>
