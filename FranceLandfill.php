...
$con=mysqli_connect('localhost','root','fluffy22','dataScience');
	$sql="SELECT * FROM franceFill ORDER BY TIME DESC";
	...
	mysqli_close($con);
	?><br><br>
<a href="links/franceFill.csv" download>Download CSV</a><br><br>
<a href="links/franceFill.xlsx" download>Download XLSX</a><br><br>
