...
$con=mysqli_connect('localhost','root','fluffy22','dataScience');
	$sql="SELECT * FROM portugalCompost ORDER BY TIME DESC";
	...
	mysqli_close($con);
	?></iframe><br><br>
<a href="links/portugalcompost.csv" download>Download CSV</a><br><br>
<a href="links/portugalcompost.xlsx" download>Download XLSX</a><br><br>
