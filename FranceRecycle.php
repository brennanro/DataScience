...
$con=mysqli_connect('localhost','root','fluffy22','dataScience');
	$sql="SELECT * FROM franceRecycle ORDER BY TIME DESC";
	...
	mysqli_close($con);
	?><br><br>
<a href="links/francerecycle.csv" download>Download CSV</a><br><br>
<a href="links/francerecycle.xlsx" download>Download XLSX</a><br><br>
