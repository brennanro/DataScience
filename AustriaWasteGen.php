...
$con=mysqli_connect('localhost','root','fluffy22','dataScience');
	$sql="SELECT * FROM austriaWaste ORDER BY TIME DESC";
	...
	mysqli_close($con);
	?><br><br>
<a href="links/austriaWaste.csv" download>Download CSV</a><br><br>
<a href="links/austriaWaste.xlsx" download>Download XLSX</a><br><br>
