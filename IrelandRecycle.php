...
$con=mysqli_connect('localhost','root','fluffy22','dataScience');
	$sql="SELECT * FROM irelandRecycle ORDER BY TIME DESC";
	...
	mysqli_close($con);
	?><br><br>
<a href="links/irelandrecycle.csv" download>Download CSV</a><br><br>
<a href="links/irelandrecycle.xlsx" download>Download XLSX</a><br><br>
