...
$con=mysqli_connect('localhost','root','fluffy22','dataScience');
	$sql="SELECT * FROM norwayIncinerate ORDER BY TIME DESC";
	...
	mysqli_close($con);
	?><br><br>
<a href="links/norwayincinerate.csv" download>Download CSV</a><br><br>
<a href="links/norwayincinerate.xlsx" download>Download XLSX</a><br><br>
