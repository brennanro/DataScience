...
$con=mysqli_connect('localhost','root','fluffy22','dataScience');
	$sql="SELECT * FROM italyFill ORDER BY TIME DESC";
	...
	mysqli_close($con);
	?><br><br>
<a href="links/italyFill.csv" download>Download CSV</a><br><br>
<a href="links/italyFill.xlsx" download>Download XLSX</a><br><br>
