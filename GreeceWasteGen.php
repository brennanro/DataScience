...
$con=mysqli_connect('localhost','root','fluffy22','dataScience');
	$sql="SELECT * FROM greeceWaste ORDER BY TIME DESC";
	...
	mysqli_close($con);
	?><br><br>
<a href="links/greeceWaste.csv" download>Download CSV</a><br><br>
<a href="links/greeceWaste.xlsx" download>Download XLSX</a><br><br>
