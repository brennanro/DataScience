...
$con=mysqli_connect('localhost','root','fluffy22','dataScience');
	$sql="SELECT * FROM italyCompost ORDER BY TIME DESC";
	...
	mysqli_close($con);
	?></iframe><br><br>
<a href="links/italycompost.csv" download>Download CSV</a><br><br>
<a href="links/italycompost.xlsx" download>Download XLSX</a><br><br>
