...
$con=mysqli_connect('localhost','root','fluffy22','dataScience');
	$sql="SELECT * FROM czechWaste ORDER BY TIME DESC";
	...
	mysqli_close($con);
	?><br><br>
<a href="links/czechWaste.csv" download>Download CSV</a><br><br>
<a href="links/czechWaste.xlsx" download>Download XLSX</a><br><br>
