...
$con=mysqli_connect('localhost','root','fluffy22','dataScience');
	$sql="SELECT * FROM portugalFill ORDER BY TIME DESC";
	...
	mysqli_close($con);
	?><br><br>
<a href="links/portugalFill.csv" download>Download CSV</a><br><br>
<a href="links/portugalFill.xlsx" download>Download XLSX</a><br><br>
