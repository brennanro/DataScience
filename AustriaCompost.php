...
$con=mysqli_connect('localhost','root','fluffy22','dataScience');
	$sql="SELECT * FROM austriaCompost ORDER BY TIME DESC";
	...
	mysqli_close($con);
	?><br><br>
<a href="links/austriacompost.csv" download>Download CSV</a><br><br>
<a href="links/austriacompost.xlsx" download>Download XLSX</a><br><br>
