...
$con=mysqli_connect('localhost','root','fluffy22','dataScience');
	$sql="SELECT * FROM austriaFill ORDER BY TIME DESC";
	...
	mysqli_close($con);
	?><br><br>
<a href="links/austriaFill.csv" download>Download CSV</a><br><br>
<a href="links/austriaFill.xlsx" download>Download XLSX</a><br><br>
