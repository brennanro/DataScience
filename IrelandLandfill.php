...
$con=mysqli_connect('localhost','root','fluffy22','dataScience');
	$sql="SELECT * FROM irelandFill ORDER BY TIME DESC";
	...
	mysqli_close($con);
	?><br><br>
<a href="links/irelandFill.csv" download>Download CSV</a><br><br>
<a href="links/irelandFill.xlsx" download>Download XLSX</a><br><br>
