...
$con=mysqli_connect('localhost','root','fluffy22','dataScience');
	$sql="SELECT * FROM romaniaWaste ORDER BY TIME DESC";
	...
	mysqli_close($con);
	?><br><br>
<a href="links/romaniaWaste.csv" download>Download CSV</a><br><br>
<a href="links/romaniaWaste.xlsx" download>Download XLSX</a><br><br>
