...
$con=mysqli_connect('localhost','root','fluffy22','dataScience');
	$sql="SELECT * FROM romaniaCompost ORDER BY TIME DESC";
	...
	mysqli_close($con);
	?><br><br>
<a href="links/romaniacompost.csv" download>Download CSV</a><br><br>
<a href="links/romaniacompost.xlsx" download>Download XLSX</a><br><br>
