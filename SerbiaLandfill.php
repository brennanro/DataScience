...
$con=mysqli_connect('localhost','root','fluffy22','dataScience');
	$sql="SELECT * FROM serbiaFill ORDER BY TIME DESC";
	...
	mysqli_close($con);
	?><br><br>
<a href="links/serbiaFill.csv" download>Download CSV</a><br><br>
<a href="links/serbiaFill.xlsx" download>Download XLSX</a><br><br>
